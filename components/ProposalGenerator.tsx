...
import { ArrowLeft, FileText, Send, User, Shield, TrendingUp, CheckCircle, Loader2 } from 'lucide-react';
              ...
              <div className="animate-fade-in space-y-6">
                <div className="glass-card p-8 rounded-2xl relative overflow-hidden">
                  ...
                  <div className="mt-8 flex justify-end">
                    <button className="flex items-center px-6 py-2 bg-white text-slate-900 rounded-full font-semibold text-sm hover:bg-slate-200 transition-colors">
